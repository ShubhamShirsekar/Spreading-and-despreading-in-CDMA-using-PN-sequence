...
//at receiver,  recieved spreaded signal multiplied with PN sequnce 
corr_code=[sum(detect_code(1:7)) sum(detect_code(8:14)) sum(detect_code(15:21))]; rec_sig=(1/7).*corr_code;
//get information form received signal 
